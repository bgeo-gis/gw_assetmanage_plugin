...
from ...ui.ui_manager import PriorityUi
...
class AmPriority(dialog.GwAction):
    ...
    def priority(self):
        ...
        # Manage radiobuttons
        self.dlg_priority.rb_select.toggled.connect(partial(self._manage_radio_buttons, 0))
        self.dlg_priority.rb_expr.toggled.connect(partial(self._manage_radio_buttons, 1))
        self.dlg_priority.rb_attr.toggled.connect(partial(self._manage_radio_buttons, 2))
        self.dlg_priority.rb_select.setChecked(True)
        self._manage_radio_buttons(0, True)
