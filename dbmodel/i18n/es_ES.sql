...
UPDATE asset.config_form_tableview SET alias = 'Diámetro' WHERE tablename = 'config_diameter_def' AND columnname = 'dnom';
UPDATE asset.config_form_tableview SET alias = 'Coste reconstrucción' WHERE tablename = 'config_diameter_def' AND columnname = 'cost_constr';
UPDATE asset.config_form_tableview SET alias = 'Coste reparación tubería' WHERE tablename = 'config_diameter_def' AND columnname = 'cost_repmain';
UPDATE asset.config_form_tableview SET alias = 'Coste reparación acometida' WHERE tablename = 'config_diameter_def' AND columnname = 'cost_repserv';
UPDATE asset.config_form_tableview SET alias = 'Normativo' WHERE tablename = 'config_diameter_def' AND columnname = 'compliance';
