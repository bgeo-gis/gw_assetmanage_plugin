...
UPDATE asset.config_form_tableview SET alias = 'Resultado' WHERE tablename = 'result_selection' AND columnname = 'result_id';
UPDATE asset.config_form_tableview SET alias = 'Selección' WHERE tablename = 'result_selection' AND columnname = 'selection_id';
UPDATE asset.config_form_tableview SET alias = 'Descripción' WHERE tablename = 'result_selection' AND columnname = 'alias';
UPDATE asset.config_form_tableview SET alias = 'Arco' WHERE tablename = 'result_selection' AND columnname = 'arc_id';
UPDATE asset.config_form_tableview SET alias = 'Usuario' WHERE tablename = 'result_selection' AND columnname = 'cur_user';
UPDATE asset.config_form_tableview SET alias = 'Fecha' WHERE tablename = 'result_selection' AND columnname = 'tstamp';