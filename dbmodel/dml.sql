...
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'result_selection', 'descript', 3, true, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'result_selection', 'arc_id', 4, true, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'result_selection', 'cur_user', 5, true, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'result_selection', 'tstamp', 6, true, NULL, NULL, '{"stretch": true}');
