...
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', '_current_ivi', 7, false, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', 'target_year', 8, false, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', '_target_ivi', 9, false, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', 'tstamp', 10, true, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', 'cur_user', 11, true, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', 'status', 12, true, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', 'presszone_id', 13, false, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', 'material_id', 14, false, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', 'features', 15, false, NULL, NULL, '{"stretch": true}');
INSERT INTO asset.config_form_tableview VALUES ('priority_manager', 'utils', 'cat_result', 'dnom', 16, false, NULL, NULL, '{"stretch": true}');
